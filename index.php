...
if(isset($_SESSION['success_msg'])){
    echo "<span class='success'>".$_SESSION['success_msg']."</span>";
    unset($_SESSION['success_msg']);

}
elseif(isset($_SESSION['err_msg'])){
    echo "<span class='err'>".$_SESSION['err_msg']."</span>";
    unset($_SESSION['err_msg']);
}

?>
<?php
if(isset($_SESSION['password_set'])){
    echo "<span class='success'>".$_SESSION['password_set']."</span>";
